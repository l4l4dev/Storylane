...
export function matrixFixtures(ctx: MatrixContext): Record<string, MatrixFixture> {
  return {
    ...
    "GET /api/projects/:id/iteration_overrides": {},
    "PUT /api/projects/:id/iteration_overrides/:number": { params: { number: "2" }, body: { length: 2 } },
    "DELETE /api/projects/:id/iteration_overrides/:number": { params: { number: "2" } },
