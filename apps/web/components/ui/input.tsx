...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <input
      type={type}
      data-slot="input"
      // No dark:disabled:bg-input/80: --input is now opaque (doc-27), so that
      // class made a *disabled* field render lighter than an *enabled* one —
      // disabled:opacity-50 alone still carries the disabled cue.
      className={cn(
