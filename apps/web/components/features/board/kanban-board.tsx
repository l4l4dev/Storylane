...
import { dropStory, updateIterationGoal } from "@/app/projects/[id]/board/actions";
...
function findContainer(
  containers: Record<string, BoardStory[]>,
  itemId: string,
): string | undefined {
...
function storyById(containers: Record<string, BoardStory[]>, id: string): BoardStory | undefined {
  for (const stories of Object.values(containers)) {
...
export function KanbanBoard({
  ...
  // above — no client-side grouping logic is duplicated for this.
