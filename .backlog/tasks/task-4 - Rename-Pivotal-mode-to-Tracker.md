...
The name "Pivotal Tracker" must never appear in the product UI (Mika, 2026-07-07). The iteration/velocity workflow mode is now called Tracker everywhere. See spec/features.md header note and spec/data-model.md (projects.workflow_mode).
