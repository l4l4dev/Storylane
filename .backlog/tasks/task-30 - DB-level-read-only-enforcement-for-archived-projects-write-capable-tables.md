...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Decide (with Mika) whether full DB-level archived read-only enforcement is actually wanted, given the broad blast radius (touches most write-capable tables' RLS policies)
