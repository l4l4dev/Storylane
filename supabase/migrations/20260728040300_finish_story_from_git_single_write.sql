...
create or replace function public.finish_story_from_git(p_project_id uuid, p_story_number int, p_provider text)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
...
-- (restore finish_story_from_git from 20260719000012_reanchor_finish_story_from_git.sql)
-- ============================================================
